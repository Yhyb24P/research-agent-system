...
The CPU/local and cloud paths do not require GPU resources. GPU admission is an
optional contract activated only when a scheduler with hardware enforcement is
selected.
