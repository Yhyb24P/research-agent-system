...
mod tests {
    ...
    use super::*;
    use crate::board::{AgentMessage, ArtifactMeta, TaskRecord};
    ...
    struct MemBoard {
        ...
        attempts: BTreeMap<u64, Vec<TaskAttempt>>,
        messages: Vec<AgentMessage>,
        artifacts: BTreeMap<u64, Vec<ArtifactMeta>>,
        next_id: u64,
    }
    ...
    fn ok_driver(summary: &str) -> Arc<dyn AgentDriver> {
        Arc::new(FixedDriver {
    ...
    fn err_driver(error: &str) -> Arc<dyn AgentDriver> {
        Arc::new(FixedDriver {
            summary: None,
    ...
    fn trio_registry() -> AgentRegistry {
